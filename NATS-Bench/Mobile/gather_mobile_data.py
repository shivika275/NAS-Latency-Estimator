...
def main(batch_size, dataset, loops, inf_temp_file, perf_temp_file, idx):
    ...
    while True:
        ...
        subprocess.run(["sh", performance_script, models_folder, results_folder, inf_temp_file, perf_temp_file])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--idx", type=int, default=0, help="Starting index for model processing")

    # Parse the arguments
    args = parser.parse_args()

    # Call main function with parsed arguments
    main(args.batch_size, args.dataset, args.loops, args.inf_temp_file, args.perf_temp_file, args.idx)